  ...
  return (
    <>
      <div className="flex gap-5">
        ...
        {/* <div> */}
                {loggedIn&&
          <div onClick={handleMyBlog} className="flex gap-2 text-white bg-slate-500 px-5 py-2 rounded-lg hover:bg-slate-400 cursor-pointer">
          <p className="text-white pt-1">My Blogs</p>
          {/* <p className="text-white pt-2"> <FiEdit /></p> */}
        </div>
        }
        {/* </div> */}
